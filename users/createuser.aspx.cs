...
public partial class createuser : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
     ...
     protected void Btnsub_Click1(object sender, EventArgs e)
     {
         ...
         int id;
         String strsql = "insert into Tbl_user ( role_id, phone , password, email,question,answer) values ('2','" + Txtphone.Text + "','" + Txtpass.Text + "','" + Txtemail.Text + "','" + Txtsquet.Text + "','" + Txtans.Text + "')";
